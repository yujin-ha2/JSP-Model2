    ...
    <!-- start 관리자 메뉴 -->
 	<section class="order_details section-margin--small">
    	<div class="container">
			...
			<form action="./NoticeRegister.ad" method="post" onsubmit="return checked()">
				...
				<div align="center">
					<!-- 글쓰기 버튼 생성 -->
					<input type="submit" class="btn btn-primary pull-right" value="등록" onclick="submitContents(this);">
					<input type="button" class="btn btn-primary pull-right" value="취소" onclick="location.href='NoticeList.ad';">
				</div>
			</form>
		</div>
	</section>
