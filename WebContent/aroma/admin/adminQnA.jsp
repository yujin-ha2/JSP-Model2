...
<body>
  		  ...
  		  <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: #3549EC;">
                <li class="nav-item">
                    <a class="nav-link active" href="adminQnA.jsp" aria-selected="true">상담하기</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${contextPath}/AdminApproveListAction.ad" aria-selected="false">승인관리</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="${contextPath}/AdminNoticeListAction.ad" aria-selected="false">공지관리</a>
                </li>
                <li class="nav-item">
		    ...
		    <div class="container">
               <table style="text-align: center; width: 100%">
                  <td width="200px"  style="border-right: 1px solid lightgray;">
                  	<img src="../img/r10.jpg" style="border-radius: 100px"/> 
                  	<br/>
		          ...
		          <td width="1000px" align="center" style="padding-left: 30px">
	                <h3 style="text-align: left">상담하기</h3>
		          </td>
		        </table>
		    </div>
		  </section>
