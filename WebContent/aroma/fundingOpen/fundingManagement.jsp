        ...
        <div class="main-panel">
          ...
          <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title col-md-1" style="padding: 0; font-weight: 500;">펀딩 관리</h4>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body" style="padding: 40px;">
                  	<div>
                    <h4 class="card-title" style="font-size: 36px; font-weight: 700; margin-bottom: 10px;">펀딩 관리</h4>
          ...
          <footer class="footer">
            <div class="container-fluid clearfix">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"><a href="#" target="_blank">GoodFunding_</a>makerStudio</span>
            </div>
          </footer>
        </div>
      </div>
