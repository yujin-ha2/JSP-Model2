              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body" style="padding: 40px;">
                    ...
                    <form action="./BasicRequireReg.on" method="post" name="basic" >
                      ...
                      <div class="row" style="margin-bottom: 20px;">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-radio form-radio-flat">
                            	<label class="form-check-label" style="	">
                            		<input type="radio" class="form-check-input" id="no" name="Q1_radio" value="no">
                           	...
                           	<div class="form-radio form-radio-flat" style="margin-bottom: 15px;">
                            	<label class="form-check-label" style="">
                            		<input type="radio" class="form-check-input" id="yes" name="Q1_radio" value="yes">
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <textarea rows="2" cols="" class="form-control" name="reward" id="reward">${bean.reward}</textarea>
                          </div>
                        </div>
                        </div>
                         <div class="row" style="margin-bottom: 20px;">
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <textarea rows="2" cols="" class="form-control" name="delivery" id="delivery">${bean.delivery}</textarea>
                          </div>
                        </div>
                        </div>
                        <div class="row" style="margin-bottom: 20px;">
