                      ...
                      <div class="row" style="margin-bottom: 20px;">
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <div>
								<input type="text" class="form-control" name="ceoName" id="ceoName" value="${bean.ceoName}">                           
                            </div>
                          </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <div>
								<input type="text" class="form-control" name="ceoEmail" id="ceoEmail" value="${bean.ceoEmail}">                           
                            </div>
                          </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <div>
                            <label class="input-file-button col-md-2" for="profile" style="text-align:center; font-size: 17px; line-height: 2.4;">업로드</label>
							<input type="file" style="display: none;" id="profile" name="profile" onchange="changeProfile(this)"/>
							</div>
							<input type="hidden" name="profile2" id="profile2" value="${bean.profile}">
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <div>
								<input type="text" class="form-control" name="makerEmail" id="makerEmail" value="${bean.makerEmail}">                           
                            </div>
                          </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <div>
								<input type="text" class="form-control" name="makerTel" id="makerTel" value="${bean.makerTel}">                           
                            </div>
                          </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <div>
								<input type="text" class="form-control" name="makerHomepage" id="makerHomepage" value="${bean.makerHomepage}">                           
                            </div>
                          </div>
                        </div>
                        </div>
                        ...
                        <div class="col-md-7">
                          <div class="form-group">
                            ...
                            <div>
                            	...
                            	<input type="text" class="form-control" placeholder="계좌번호" style="margin: 6px 0;" name="accountNumber" id="accountNumber" value="${bean.accountNumber}">
                            	<p style="font-size: 13px; color: #90949c; margin-bottom: 2px;">
                           		- 특수문자(-)없이 숫자만 입력해주세요.
                           		</p>
                            	<input type="text" class="form-control" placeholder="예금주 명 입력" style="margin: 6px 0;" name="accountHolder" id="accountHolder" value="${bean.accountHolder}">
                            	<p style="font-size: 13px; color: #90949c;">
	                    ...
	                    <div class="col-md-3" style="padding-left: 0;">
	                    	<input type="submit" class="saveBtn" value="수정하기">
	                    </div>
                    </form>
                  </div>
                </div>
