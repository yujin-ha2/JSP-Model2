			               		...
			               		<tbody>
			               			...
			               			<tr>
				                   		...
				                   		<td style="word-break:break-all" width="40%">  
				                   			<input type="text" id="answer${list.detailId}" name="answer${list.detailId}" class="form-control" value="${list.detailContent}">
				                   		</td>
			                   		</tr> 
				               		</c:forEach>
			                   	</tbody>
...
-A/S불가 규정: 보증기간 이내일지라도 사용자의 고의 또는 과실로 인하여 제품 수리 및 재생이 불가능한 경우">${policy}</textarea>
