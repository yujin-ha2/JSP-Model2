...
<head>
    ...
    <script type="text/javascript">
	    var id = String($('#dynamicTbody tr:last').attr('id'));
		var index = id.substr(12, id.length);
		...
		function addRow(obj) {
			...
			html += '<tr id="dynamicTr'+index+'">';
       		html += '<td style="word-break:break-all; padding: 12px 6px;" width="30%"><input type="text" class="form-control" id="option" name="option"></td>';
       		html += '<td style="word-break:break-all; padding: 12px 6px;" width="30%"><input type="text" class="form-control" id="optionDetail" name="optionDetail"></td>';
       		html += '<td style="word-break:break-all; padding: 12px 6px;" width="15%"><input type="text" class="form-control" id="price" name="price" onkeyup="inputNumberFormat(this)"></td>';
       		html += '<td style="word-break:break-all; padding: 12px 6px;" width="10%"><input type="text" class="form-control" id="quantity" name="quantity" onkeyup="inputNumberFormat(this)"></td>';
       		html += '<td style="word-break:break-all; padding: 12px 6px;" width="15%"><input type="text" class="form-control" id="deliveryDate" name="deliveryDate"></td>';
       		html += '<td style="word-break:break-all; padding: 12px 6px;" width="10%"><input type="text" class="form-control" id="deliveryFee" name="deliveryFee" onkeyup="inputNumberFormat(this)"></td>';
                    ...
                    <input type="hidden" name="cmd" id="cmd" value="update">
                      <div class="row" style="margin-bottom: 20px;">
                            ...
                            <div style="margin: 30px 0;" id="Categories">
	                          <table class="table table-hover">
			               		...
			               		<tbody id="dynamicTbody">
									<c:forEach var="list" items="${rewardList}" varStatus="status">
									<tr id="dynamicTr${status.count}">
										<td style="word-break:break-all; padding: 12px 6px;" width="30%" >
											<input type="text" class="form-control" id="option" name="option" value="${list.rewardOption}">
										</td>
										<td style="word-break:break-all; padding: 12px 6px;" width="30%">
											<input type="text" class="form-control" id="optionDetail" name="optionDetail" value="${list.rewardDetail}">
										</td>
										<td style="word-break:break-all; padding: 12px 6px;" width="15%">
											<fmt:formatNumber var="price" type="number" pattern="#,###" value="${list.price}"/>
											<input type="text" class="form-control" id="price" name="price" onkeyup="inputNumberFormat(this)" value="${price}">
										</td>
										<td style="word-break:break-all; padding: 12px 6px;" width="10%">
											<fmt:formatNumber var="quantity" type="number" pattern="#,###" value="${list.salesQuantity}"/>
											<input type="text" class="form-control" id="quantity" name="quantity" onkeyup="inputNumberFormat(this)" value="${quantity}">
										</td>
										<td style="word-break:break-all; padding: 12px 6px;" width="15%">
											<input type="text" class="form-control" id="deliveryDate" name="deliveryDate" value="${list.deliveryDate}">
										</td>
										<td style="word-break:break-all; padding: 12px 6px;" width="10%">
											<fmt:formatNumber var="fee" type="number" pattern="#,###" value="${list.deliveryFee}"/>
											<input type="text" class="form-control" id="deliveryFee" name="deliveryFee" onkeyup="inputNumberFormat(this)" value="${fee}">
										</td>
										<td style="word-break:break-all; padding: 12px 6px;" width="5%">
	                    ...
	                    <div class="col-md-3" style="padding-left: 0;">
	                    	<input type="button" class="saveBtn" value="수정하기" onclick="inputCheck()">
	                	</div>
                    </form>
                  </div>
                </div>
