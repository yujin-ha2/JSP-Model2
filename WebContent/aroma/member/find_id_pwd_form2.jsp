		    ...
		    <a class="nav-link" id="find_pwd-tab" data-toggle="tab" href="#find_pwd" role="tab" aria-controls="find_pwd" aria-selected="false">비밀번호 찾기</a>
			 ...
			 <!--================아이디찾기 =================-->
			  <div class="tab-pane fade show active" id="find_id" role="tabpanel" aria-labelledby="find_id-tab"  align="center">
			   <div class="col-lg-8" style="padding-top: 80px; height:450px""><br>
         
         <form class="row contact_form" method="post" id="f" action="" onsubmit ="return check(this);">
           <c:set var="member" value="${requestScope.mb}"/>
            <div class="col-md-12 form-group p_star" style="margin: 50px 0">
            <h6 align="left">회원님의 아이디는? 
            <span style="font-size: 40px; padding-left:90px">실험용아이디${member.id}</span>     
            </h6>
           </div>
             <div class="col-md-12 form-group" align="center" style="margin-top: 30px ">
          	 <button type="submit" value="submit" class="button button-tracking">로그인하러 가기</button>
